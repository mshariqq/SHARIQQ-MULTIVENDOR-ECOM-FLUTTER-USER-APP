...
import 'package:shariqq_multivendor_ecom_userapp/view/basewidget/product_widget.dart';
import 'package:shariqq_multivendor_ecom_userapp/view/screen/search/widget/search_filter_bottom_sheet.dart';
            ...
            children: [
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  child: Row(children: [
                    Icon(Icons.filter_alt_rounded, size: 18, color: Theme.of(context).primaryColor,),
