import 'package:shariqq_multivendor_ecom_userapp/data/model/response/language_model.dart';

class AppConstants {
  static const String APP_NAME = 'Shariqq Multivendor Ecom';

  static const String BASE_URL = 'https://superrexiconnect.com/';
  static const String USER_ID = 'userId';
  static const String NAME = 'name';
  static const String CATEGORIES_URI = '/api/v1/categories';
  static const String BRANDS_URI = '/api/v1/brands';
  static const String BRAND_PRODUCT_URI = '/api/v1/brands/papi/v1/configroducts/';
  ...
  static const String TOPIC = 'shariqq';
