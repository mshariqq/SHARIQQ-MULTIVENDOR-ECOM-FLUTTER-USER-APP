...
import 'package:shariqq_multivendor_ecom_userapp/view/basewidget/search_widget.dart';
import 'package:shariqq_multivendor_ecom_userapp/view/screen/chat/top_seller_chat_screen.dart';
...
class TopSellerProductScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    print(
        '====Top seller Name=====>${topSeller.name} ========id =====>${topSeller.id}');
    ...
    Provider.of<ProductProvider>(context, listen: false)
        .initSellerProductList(topSeller.id.toString(), 1, context);
